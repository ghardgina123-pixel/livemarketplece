...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "O marketplace onde clientes e lojas se conectam em tempo real." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Live Market — Compre, Converse e Receba." },
      { name: "twitter:description", content: "O marketplace onde clientes e lojas se conectam em tempo real." },
